...
{
    public partial class Employee_Tenure : System.Web.UI.Page
    {
        DataTable dt;
        ...
        {
            dt = new DataTable();
            dt = dashb.DisplayTenure(txtSearch.Text);
            return dt;
        }
        ...
        protected void gvEmployee_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (Session["SortedView_t"] != null)
            {
                gvEmployee.DataSource = Session["SortedView_t"];
                gvEmployee.DataBind();
            }
            else
            {
        ...
        protected void gvEmployee_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            Session["SortedView_t"] = sortedView;
