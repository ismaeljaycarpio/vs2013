...
{
    public partial class evaluation_employee : System.Web.UI.Page
    {
        ...
        protected void gvEmployee_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            Session["SortedView_eval_employee"] = sortedView;
        ...
        protected void gvEmployee_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (Session["SortedView_eval_employee"] != null)
            {
                gvEmployee.DataSource = Session["SortedView_eval_employee"];
                gvEmployee.DataBind();
            }
            else
            {
        ...
        protected void gvEmployee_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("~/eval-employee/evaluation-employee-form.aspx");
        }
