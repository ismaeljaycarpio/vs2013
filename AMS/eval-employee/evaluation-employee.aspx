<%@ Page Title="Employee Evaluation" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="evaluation-employee.aspx.cs" Inherits="AMS.eval_employee.evaluation_employee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5>List of Employees You Can Evaluate</h5>
                </div>
    ...
    <asp:HyperLink ID="hlEvaluationEmployee" runat="server" NavigateUrl="~/eval-employee/evaluation-employee-form.aspx"></asp:HyperLink>
</asp:Content>
